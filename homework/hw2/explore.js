...
explore.tle = function(line1, line2) {
    ...
    this.getLookAnglesFrom = function(_longitude,_latitude, elevation){
    	...
    	var radAngles = explore.satellite.ecf_to_look_angles(my_geodetic,this.position_ecf)
        return {azimuth:radAngles.azimuth*RAD2DEG,elevation:radAngles.elevation*RAD2DEG, range_sat:radAngles.range_sat}
    }
}
